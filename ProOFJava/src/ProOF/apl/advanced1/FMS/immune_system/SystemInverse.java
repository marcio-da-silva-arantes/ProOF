 ...
 * @author marcio
 */
public class SystemInverse extends AIS{
    ...
    public int n_clones(int index) {
        return Math.max(0,(int)(antibodies_number * cloning_rate/(index+1) + 0.5));
    }
    ...
    public void parameters(LinkerParameters link) throws Exception {
        ...
        //cloning_rate        = link.Dbl("cloning rate", 0.5, 1e-3, 1e6);
...
//        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        SystemInverse  test = new SystemInverse();
        test.antibodies_number = 100;
        test.clones_number = 10000;
        test.start();
    }
