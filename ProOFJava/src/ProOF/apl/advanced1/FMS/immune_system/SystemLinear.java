 ...
 * @author marcio
 */
public class SystemLinear extends AIS{
    ...
    public int n_clones(int index) {
        return Math.max(0,(int)(cloning_rate * (antibodies_number - index/cloning_spread) + 0.5));
    }
...
//        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        SystemLinear  test = new SystemLinear();
        test.antibodies_number = 100;
        test.clones_number = 10000;
        test.cloning_spread = 1;
        test.start();
    }
